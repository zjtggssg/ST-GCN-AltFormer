...
class TS_new(nn.Module):
    ...
    def Spatial_forward_features(self, x):
        ...
        # print("x1", x.shape) ###2880 22 512

        b, p, c = x.shape

        x = rearrange(x, '(b f) p  c  -> b  c f p', f =f)
    ...
    def forward(self, x):
        ...
        feature = self.Spatial_forward_features(x)
        ...
        # feature_time = feature_time.squeeze(2)

...
from model.model_ST_new import ST_new
...
from model.model_TS_new import TS_new
...
class ST_GCN_AltFormer_new(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout=0.5,
                 agcn=True):
        super(ST_GCN_AltFormer_new, self).__init__()
        if graph is None:
            raise ValueError()
        else:
            # print(graph)
        ...
        self.modelA = ST_new(num_class, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256, depth=6,
                                num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None, drop_path_rate=0.1)

        # self.modelB = TS_new(num_class, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256,
        #                                   depth=6,
        #                                   num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None, drop_path_rate=0.1)

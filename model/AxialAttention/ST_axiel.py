...
from model.AxialAttention.AxialAttention import AxialAttention_dynamic_Block
...
class ST_Axiel(nn.Module):
    def __init__(self, class_num, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256, depth=4,
        ...
        self.blocks = nn.ModuleList([
            AxialAttention_dynamic_Block(
                in_planes = embed_dim, out_planes = embed_dim, groups=8, kernel_size=180,
                proj_drop=0.
                )
           ])

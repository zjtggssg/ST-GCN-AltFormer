...
from model.ST_TR.GCN_T import GCN_T
from model.ST_TR.T_TCN import T_TCN
...
class ST_TR(nn.Module):
    ...
    def __init__(self,
        ...
        self.modelA = GCN_T(num_class, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256, depth=6,
                     num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None, drop_path_rate=0.1)

        self.modelB = T_TCN(num_class, self.A,num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256,
                     depth=6,mask_learning = mask_learning ,use_local_bn=use_local_bn,
                     num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None, drop_path_rate=0.1)

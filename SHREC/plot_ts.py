...
def plot_cam_pic(normalized_matrix,style,pd = None):
    ...
    plt.ylabel("joints")
    plt.savefig('/data/zjt/HandGestureDataset_SHREC2017/gesture/TS/{}_{}_{}_no.png'.format(style,selected_index,pd))
...
if __name__ == '__main__':
    ...
    # print("class_st-ts", class_prob_final )
    print("gailv", pred_ts)
    # print("class_ts",class_ts)
    # print("gailv", class_ts)

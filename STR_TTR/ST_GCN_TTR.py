from STR_TTR.STR import STR
from STR_TTR.TTR import TTR
...
class ST_GCN_TTR(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout=0.5,
                 agcn=True):
        super(ST_GCN_TTR, self).__init__()
        if graph is None:
            raise ValueError()
        else:
            # print(graph)
        ...
        self.modelA = TTR(num_class, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256, depth=6,

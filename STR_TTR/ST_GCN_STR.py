...
class ST_GCN_STR(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout=0.5,
                 agcn=True):
        super(ST_GCN_STR, self).__init__()
        if graph is None:
            raise ValueError()
        else:
            # print(graph)
        ...
        self.modelA = STR(num_class, num_frame=180, num_joints=22, in_chans=128, embed_dim_ratio=256, depth=6,

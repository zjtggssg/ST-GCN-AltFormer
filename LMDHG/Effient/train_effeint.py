...
from LMDHG.Effient.model.nets import EfficientGCN
...
def init_model():
    ...
    graph_args = dict(l)
    address = 'graph.LMDHG'
    model = EfficientGCN(data_shape, block_args, fusion_stage, stem_channel, **kwargs)
...
if __name__ == "__main__":
    ...
    model_fold = "/data/zjt/LMDHG/Effient/LMDHG_dp-{}_lr-{}/".format(args.dp_rate,
                                                            args.learning_rate)
    try:
        os.mkdir(model_fold)
    except:
